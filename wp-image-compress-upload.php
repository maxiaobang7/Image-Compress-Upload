<?php
/**
 * Plugin Name: WP Image Compress Upload
 * Plugin URI:  https://www.tudingai.com/
 * Description: 在 Gutenberg 编辑器侧边栏新增「压缩上传」面板，图片在浏览器本地压缩为 WebP（质量可调，默认 80%，最大宽度 1920px）后再上传到媒体库，并自动插入光标所在位置。
 * Version:     1.2.0
 * Author:      马小帮
